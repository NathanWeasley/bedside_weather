...
using IconMask1 = Mask<8, 25, METHOD_LSHIFT, 10, Wnd1>;
using IconMask2 = Mask<8, 25, METHOD_LSHIFT, 20, Wnd1>;

using Screen = Display<LED_WIDTH, LED_HEIGHT, g_vram>;
using IconZone1 = DisplayZone<IconMask1, 0, 0, Screen>;
using IconZone2 = DisplayZone<IconMask2, 0, 0, Screen>;
...
extern "C" void test_task_init(task_param_t * param)
{
    ...
    draw_string<Wnd2>(0, 8, "0123456789!@#$%^&*()-=_+[]{};':\",.<>/?\\|", font5_table, 255);
}
...
extern "C" void test_task_tick()
{
    ...
    // Repaint
    gfx_update_img(Screen::data(), Screen::data());
}
